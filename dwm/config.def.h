...
static const char *sscmd[] = { "/bin/sh", "-c", "maim -s | xclip -selection clipboard -t image/png", NULL };
static const char *termcmd[]  = { "st", "-e", "bash", "--login", NULL };
static const char *vol_up[]   = { "pactl", "set-sink-volume", "@DEFAULT_SINK@", "+10%", NULL };
static const char *vol_down[] = { "pactl", "set-sink-volume", "@DEFAULT_SINK@", "-10%", NULL };
